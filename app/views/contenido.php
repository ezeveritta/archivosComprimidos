...
<body>
    <div role="main" class="contain d-flex justify-content-center">
        <form action="actions/comprimir.php" method="post" class="border px-5 py-3 mt-5 rounded bg-light">
            ...
            <?php
                ...
                foreach ($contenido as $archivo)
                {
                    echo    "<label class=\"d-block m-1\">
                                ...
                                <a href=\"actions/eliminar.php?archivo=../../public/files/$archivo\" class=\"btn_eliminar float-right\">x</a>
                             </label>";
                    $indice++;
                }
            ?>
